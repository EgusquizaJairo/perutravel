          ...
          <Grid
              ...
              <div style={{height: hideCameras? "4px":camarasHeight, position:"relative"}}>
                <div className="icono-camaras">
                  <Tooltip title={hideCameras? "Mostrar Miembros" : "Ocultar Miembros"} sx={{backgroundColor: "white"}} placement="top-start">
                ...
                {!hideCameras && <Carousel breakPoints={breakPoints} pagination={false}>
                  <div className={hideCameras? "wrapper-hidden" : "wrapper"}>
                    <Tooltip title="Pinear miembro" followCursor sx={{backgroundColor: "white"}}>
                      <video
                        playsInline
              ...
              <Grid item md={12} sm={12} xs={12} style={{ display:"flex", justifyContent:"center", paddingBottom:"5px" }}>
                <Grid item md={hideChat? 8: 10} sm={hideChat? 7 : 12} xs={12} style={{ backgroundColor: "rgba(254,114,1)", borderRadius: "30px", alignItems:"center"}}>
                  <Grid container spacing={3} display="flex" justifyContent="center" alignItems="center">
                    <Grid item style={{ textAlign: "center" }}>
                      <IconButton onClick={handleOnClickCamera} sx={{borderRadius:"100%"}}>
                        {devices.video ? <Videocam /> : <VideocamOff />}
                      </IconButton>
                    </Grid>
                    <Grid item style={{ textAlign: "center" }}>
                      <IconButton onClick={handleOnClickMic} sx={{borderRadius:"100%"}}>
                    ...
                    <Grid item style={{ textAlign: "center" }}>
                      <Tooltip title={hideChat? "Mostrar Chat" : "Ocultar Chat"} sx={{backgroundColor: "white"}}>
                        <IconButton onClick={handleChangeHideChat} sx={{borderRadius:"100%"}}>
                          <ChatBubbleIcon />
                        </IconButton>
                      </Tooltip> 
                    </Grid>
                    <Grid item style={{ textAlign: "center" }}>
                      {!joinedMeeting ? (
                        <IconButton onClick={handleOnClickJoinMeeting} sx={{borderRadius:"100%"}}>
                          <Call />
                        </IconButton>
                      ) : (
                        <IconButton onClick={handleOnClickExitMeeting} sx={{borderRadius:"100%"}}>
                          <CallEnd />
                        </IconButton>
                      )}
                    </Grid>
                    <Grid item style={{ textAlign: "center" }}>
                      {joinedMeeting ? (
                        <Button variant="contained" size="small" onClick={() => cerrarSesion()} >Cerrar Sesión</Button>
                      ) : (
                        null
                      )}
                    </Grid>
