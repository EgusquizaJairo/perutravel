...
const slice = createSlice({
  ...
  reducers: {
    ...
    const {empleadoX} = action.payload;
      state.empleado = [...state.empleado, empleadoX];
    },
    // getEmpleado(state){
...
export const setEmpleado = (data) => (dispatch)=>{
  // console.log(data);
  dispatch(slice.actions.setEmpleado(data));
};

// export const getEmpleado = () => (dispatch)=>{
//   return dispatch(slice.actions.getEmpleado());
// }
