import { Box, Typography ,Button, Dialog, DialogContent,Grid
  , InputLabel, Select,
  MenuItem,FormControl,Slide, Alert, IconButton} from '@mui/material';
  ...
  import { Legend1, Pasos } from 'src/utils/assets';
      ...
      <>
        <Grid container xs={12}>
          <Grid item xs={2} md={.5} sm = {.5}>
              <IconButton size="small" onClick={returnToCourses}>
          ...
          <Grid container xs={12} md={4} sm={4} alignItems='center'>
        ...
        <Typography variant="subtitle2" display='flex' sx={{mr:"1rem"}}>
          Sobre mí: &nbsp;
          {associated.description || "Hola, te intivo a conocer los cursos que puedes aprender conmigo."}
        </Typography>
        </Grid>
        ...
        >
            ...
            >
              <div style={{display:"flex", justifyContent:"center"}}>
                <img alt="pasos" src={Pasos} width="100%" style={{height: "80vh"}}/>
              </div>
              <div style={{display:"flex", justifyContent:"center"}}>
                <Button
                    size="small"
        ...
        <Grid
          ...
          spacing={2}
        >
        <Grid item xs={3} style={{textAlign:'center', background:'rgb(252 252 252)', paddingRight:"5px"}}>
          ...
          <Grid container justifyContent='center'>
            <Typography variant="h4" component="h4" sx={{ pt: 1 }}>
              {formatNameCapitals(associated.fullName.replace(',', ''))}
            </Typography>
       ...
       {/* Parte de la derecha del modal de reserva */}
        ...
        <Grid item sm={8} >
          ...
          <Typography color={horario.length === 0? "#8e8e8e": "black"}>
                {horario && (horario.length === 0? "No se ha seleccionado algún horario": horario)}
          </Typography>
          </Box>
