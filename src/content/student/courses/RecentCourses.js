                ...
                <Fragment key={a.id}>
                  ...
                  >
                    ...
                    >
                        ...
                        <img
                          // src={a.photoUrl}
                          src={(a.urlPhoto!=null && a.urlPhoto!=="") ? (a.urlPhoto.split('#').length > 1 ? a.urlPhoto.split('#')[1] : a.urlPhoto) :
                    ...
                    <ListItemText
                      primary={
                        <>
                          ...
                          <Grid display='flex' alignItems='center'>
                            <SchoolRoundedIcon style={{fontSize: 15, marginRight: '5px', color: 'rgb(93 143 255)'}}/> 
                            <Typography variant="h6">{formatNameCapitals(a.university + ' - ' + a.major)}</Typography>
                          </Grid>)
                          :(<></>)}
                        </>
                      }
                      ...
                      secondary={
                        <Grid display='flex' alignItems='center'>
                          <AssignmentIndIcon style={{fontSize: 15, marginRight: '5px', color: '#5dc0e2'}}/>
                          {a.description || ''}
                        </Grid>
                      }
