...
//  ]
  ...
  const handleCreateProjectSuccess = () => {
    enqueueSnackbar('Se ha registrado la sala satisfactoriamente', {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
  ...
  const enviarRequest = async () => {
    ...
    //  };
      ...
      // formData.append("tipo_layout", imagen.type);
      // formData.append("nombre_layout", imagen.name);
      const response = await certifyAxiosImages.post('/slot_room/new/imagen', formData)
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea crear una nueva sala?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se creará una nueva sala.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
