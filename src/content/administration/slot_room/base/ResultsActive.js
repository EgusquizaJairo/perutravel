...
const ResultsActive = (props) => {
  ...
  const aceptarRequest = async () =>{
    ...
    try{
    const response= await certifyAxios.post('/slot_room/update/mini', reqObj);
  ...
  const modificarEmpleado = (associated) =>{
    ...
    // console.log(a);
    localStorage.setItem("sala",JSON.stringify(associated));
    navigate('/sapt/manager/slot_room/modify');
  }
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea deshabilitar la sala?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se deshabilitará la sala.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
