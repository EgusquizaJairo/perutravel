...
//  ]
  ...
  const handleCreateProjectSuccess = () => {
    enqueueSnackbar('Se ha modificado la máquina satisfactoriamente', {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
    ...
    maquina.nombre = nombres;
    maquina.id_modelo = inModelo;
    maquina.id_juego = inJuego;
    maquina.nro_serie = serie;
    maquina.id_sala = inSala;
    maquina.posrelativa = relativo;
  ...
  const enviarRequest = async () => {
    try {
      ...
      const response = await certifyAxios.post('/machine/update', request);
  ...
  useEffect(async()=>{
    let maquinaX = JSON.parse(localStorage.getItem("maquina"));
    if(maquinaX==null) navigate('/sapt/manager/machine');
    // console.log(maquinaX);
    setMaquina(maquinaX);
    setNombres(maquinaX.nombre);
    setinModelo(maquinaX.id_modelo);
    setinJuego(maquinaX.id_juego);
    setSerie(maquinaX.nro_serie);
    setinSala(maquinaX.id_sala);
    setRelativo(maquinaX.posrelativa);
    console.log(maquina);
    leerModelos();
    leerJuegos(); 
    leerSalas();
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea modificar la máquina?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se modificará la máquina.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
