...
const ResultsActive = (props) => {
  ...
  const modificarEmpleado = (associated) =>{
    ...
    // console.log(a);
    localStorage.setItem("maquina",JSON.stringify(associated));
    navigate('/sapt/manager/machine/modify');
  }
                    ...
                    return (
                      <>
                        ...
                        <TableCell align='center'>
                          ...
                          <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {`${associated.NombreFabricante} - ${associated.NombreModelo}`}
                            </Typography>
                          </TableCell>
