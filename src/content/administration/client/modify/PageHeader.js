...
const [cargoTypeOptions,setcargoTypeOptions] = useState([
  ...
  // Llamar al ws por la lectora
    ...
    let clienteX = JSON.parse(localStorage.getItem("cliente"));
    ...
    setCorreo(clienteX.correo);
    setDireccion(clienteX.direccion);
    setStart(clienteX.fecha_nac);
    setCargo(clienteX.id_tipo_cliente);
    // setCargo(empleadoX.id_cargo);
    setTipoDoc(clienteX.id_documento);
    setSexo(clienteX.id_sexo);
    setNroDoc(clienteX.nro_documento); 
    setCelular(clienteX.telefono);
    setTarjeta(clienteX.NroTarjeta);
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea modificar al cliente?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se modificará al cliente.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
