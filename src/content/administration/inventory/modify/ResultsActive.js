...
const ResultsActive = (props) => {
  ...
  const aceptarRequest = async () =>{
    const reqObj ={
     // "id_maquina":soy.id_maquina,
     "tipo":0
    };

    try{
    const response= await certifyAxios.post('/machine/update/mini', reqObj);
  ...
  //   // console.log(a);
  //   localStorage.setItem("inventario",JSON.stringify(associated));
  //   navigate('/sapt/manager/inventory/detail');
  // }
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align='center'>Nro. Serie</TableCell>
                    <TableCell align='center'>Sala</TableCell>
                    <TableCell align='center'>Nro.en Sala</TableCell> */}
                      ...
                      <>
                        ...
                        <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {associated.tipo === 1 ? "Entrada de Productos":"Salida de Productos"}
                            </Typography>
                          </TableCell>
                          ...
                          <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {associated.nombreEmpleado}
                            </Typography>
                          </TableCell>

                          {/* <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {associated.NombreJuego}
                            </Typography>
                          </TableCell>
                          <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {associated.nro_serie}
                            </Typography>
                          </TableCell>
                          <TableCell align='center'>
                           <Typography noWrap variant="h5">
                               {associated.NombreSala}
                            </Typography>
                          </TableCell>
                          <TableCell align='center'>
                           <Typography noWrap variant="h5">
                          ...
                          <TableCell align='center' >
                          <Typography noWrap variant="h5">
                             {moment(associated.fecha).format('YYYY-MM-DD hh:mm:ss a')}
                            </Typography>
                              {/* <Button onClick={()=>{
                                  setSoy(associated);
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea deshabilitar la máquina?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se deshabilitará la máquina.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
