...
//  ]
  ...
  const handleCreateProjectSuccess = () => {
    enqueueSnackbar('Se ha registrado la orden satisfactoriamente', {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
  ...
  const enviarRequest = async () => {
    try {
      ...
      const response = await certifyAxios.post('/inventory/new', request);
  ...
  const leerModelos = async () =>{
    ...
    const response = await certifyAxios.post('/product/query', request);
            ...
            <Grid item md={12}>
              ...
              >
                  ...
                  <Select style={{backgroundColor:'#FFFFFF'}}
                      ...
                      fullWidth
                      onChange={(e)=>{
                        setinTipo(e.target.value)
                      }}
                    >
                      {TipoTypeOptions.map((TypeOption) => (
                        <MenuItem
                          key={TypeOption.id}
                          value={TypeOption.id}
                        >
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea registrar una nueva orden?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se registrará una nueva orden.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
