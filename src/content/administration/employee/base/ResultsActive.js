...
const ResultsActive = (props) => {
  ...
  const aceptarRequest = async () =>{
    const reqObj ={
     "id_empleado":soy.id_empleado,
     "tipo":0
    };

    try{
    const response= await certifyAxios.post('/person/employee/update/mini', reqObj);
  ...
  const modificarEmpleado = (associated) =>{
    ...
    // console.log(a);
    localStorage.setItem("empleado",JSON.stringify(associated));
    navigate('/sapt/manager/employee/modify');
  }
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea deshabilitar al empleado?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se deshabilitará al empleado.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
