...
export default function BasicTabs(props) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      {props.selectedTaller && ( (props.selectedTaller.resource1 !== null && props.selectedTaller.resource1 !== "") || (props.selectedTaller.resource2!=null && props.selectedTaller.resource2 !== "") 
        || (props.selectedTaller.resource3 !== null && props.selectedTaller.resource3 !== "")) &&
        <TabPanel value={value} index={1}>
          Material adicional de para este taller
          <List disablePadding component="div">
            {props.selectedTaller && props.selectedTaller.resource1 !== "" && props.selectedTaller.resource1 !== null && <ListItem disableGutters component="div" key={1}>
              <Alert
                  sx={{
                      py: 0,
                      mt: 2,
            ...
            {props.selectedTaller && props.selectedTaller.resource2 !== "" && props.selectedTaller.resource2 !== null && <ListItem disableGutters component="div" key={2}>
              <Alert
                  sx={{
                      py: 0,
                      mt: 2,
            ...
            { props.selectedTaller && props.selectedTaller.resource3 !== "" && props.selectedTaller.resource3 !== null && <ListItem disableGutters component="div" key={3}>
              <Alert
                  sx={{
                      py: 0,
                      mt: 2,
