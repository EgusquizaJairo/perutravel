...
const calcularMerito = (merito) => {

  if (merito === 1) {
    console.log('Medio Superior');
    ...
    return 'Décimo Superior';
  }
  // console.log('Sin Merito');
  return 'Sin Merito';
};
                ...
                <Grid item xs={5}>
                  ...
                  >
                    <Typography variant="h6" style={{ backgroundColor: (!instituteNameNew) ? '#FEFEFE' : '#FFEEEE' }}>
                      {formatNameCapitals(instituteNameOld)}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={5}>
                  ...
                  >
                    <Typography variant="h6" style={{ backgroundColor: (!instituteNameNew) ? '#FEFEFE' : '#EBFFDE' }}>
                      {formatNameCapitals(instituteNameNew) || formatNameCapitals(instituteNameOld)}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={2}>
                ...
                <Grid item xs={5}>
                  ...
                  >
                    <Typography variant="h6" style={{ backgroundColor: (!majorNameNew) ? '#FEFEFE' : '#EBFFDE' }}>
                      {formatNameCapitals(majorNameNew) || formatNameCapitals(majorNameOld)}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={2}>
                ...
                <Grid item xs={5}>
                  ...
                  >
                    <Typography variant="h6" style={{ backgroundColor: (!meritNew) ? '#FEFEFE' : '#FFEEEE' }}>
                      ...
                      {formatNameCapitals(calcularMerito(meritOld))}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={5}>
                  ...
                  >
                    <Typography variant="h6" style={{ backgroundColor: (!meritNew) ? '#FEFEFE' : '#EBFFDE' }}>
                      ...
                      {meritNew ? formatNameCapitals(calcularMerito(meritNew)) : formatNameCapitals(calcularMerito(meritOld))}
                    </Typography>
                  </Box>
                </Grid>
