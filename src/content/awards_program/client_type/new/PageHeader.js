...
function PageHeader() {
  ...
  const handleCreateProjectSuccess = () => {
    enqueueSnackbar('Se ha registrado el tipo de cliente satisfactoriamente', {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
  ...
  const enviarRequest = async () => {
    try {
      ...
      const response = await certifyAxios.post('/tipo_cliente/new', reqObj)
            ...
            <Dialog
                ...
                >
                  <DialogTitle id="alert-dialog-title">
                    ¿Desea crear un nuevo tipo de cliente?
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Se creará un nuevo tipo de cliente.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
