...
const ResultsActive = (props) => {
  ...
  const modificarEmpleado = (associated) =>{
    ...
    // console.log(a);
    localStorage.setItem("tipo_cliente",JSON.stringify(associated));
    navigate('/sapt/manager/nclient_type/modify');
  }
