...
import { Grid, Tab,  TextField, Box } from '@mui/material';
  ...
  return (
    <>
       ...
       <div style={{display: 'flex',alignItems: 'center'}}>
        {/* Buscadores */}
            ...
            <TextField style={{marginLeft:'1%'}}
              ...
              variant="outlined" 
            />      
            <TextField style={{marginLeft:'1%',width:'15%'}}
              sx={{
                m: 0
              }}
              // InputProps={{
      ...
      {/* Botón para buscar */}
              ...
              <TabList onChange={handleChange} style={{marginLeft:'15%'}}
                sx={{
