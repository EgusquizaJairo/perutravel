      ...
      <div className="messages-header">
        ...
        >
          <Avatar
            ...
            alt="Zain Baptista"
            src={props.targetUser !== null && props.targetUser.person ? (props.targetUser.person.profilePictureURL !== null ? (props.targetUser.person.profilePictureURL.split('#').length > 1 ? props.targetUser.person.profilePictureURL.split('#')[1] : props.targetUser.person.profilePictureURL) : null) : null}
          />
          <Box
            sx={{
              pl: { sm: 1.5 },
